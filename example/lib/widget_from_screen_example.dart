...
class WidgetFromScreenExample extends StatefulWidget {
  const WidgetFromScreenExample({super.key});

  @override
  State<WidgetFromScreenExample> createState() =>
      _WidgetFromScreenExampleState();
}

class _WidgetFromScreenExampleState extends State<WidgetFromScreenExample> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Widget from screen example'),
        ),
        body: Center(
            child: Column(
